...
module.exports = {
    name: "fishing",
    description: "Starts a Fishington Discord Game Session",
    usage: "",
    permissions: {
    ...
    run: async (client, message, args, { GuildDB }) => {
        ...
        .setAuthor("Fishington Game", "https://cdn.discordapp.com/attachments/833753190859407411/891748517733883934/fishington-io.jpg")
        .setThumbnail('https://i.postimg.cc/Ghry8Yjz/3dgifmaker34216.gif')
        .setColor("RANDOM")
        .setDescription(`Using **Fishington** you can play Fishington in a Voice Channel. Click ***Join Fishington*** to join in!

        __**[Join Fishington](https://discord.com/invite/${Invite.code})**__
